...
fn build_shell_integration_group() -> DoctorGroup {
    ...
    checks.push(wrapper_check(
        "Hiterm Wrapper Script",
        managed_wrapper_path(),
        DoctorStatus::Fail,
        vec![
            "The `hiterm` shell command is provided by this wrapper".to_string(),
            "Wrapper is generated by `hiterm init` before shell setup runs".to_string(),
        ],
    ));
