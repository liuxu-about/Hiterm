...
- AI chat and shell flows are core product surfaces. Before changing `hiterm-gui/src/ai_*`, `ai_chat_engine/`, `cli_chat/`, or `overlay/ai_chat/`, read `hiterm-gui/AGENTS.md`.
